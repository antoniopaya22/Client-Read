...
var DeviceService = /** @class */ (function () {
    function DeviceService(http, userApi) {
        this.http = http;
        this.userApi = userApi;
        this.APIEndPoint = _environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiendpoint;
    }
    DeviceService.prototype.getLatestData = function () {
        var uri = this.APIEndPoint + "/data/devices";
    ...
    DeviceService.prototype.getAllData = function () {
        var consulta = {
            "selector": {},
            "sort": [
                {
        ...
        var uri = this.APIEndPoint + "/data/query";
        var httpHeaders = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
            'Content-Type': 'application/json',
            'Authorization': "" + this.userApi.getToken()
        });
    ...
    DeviceService.prototype.getHistoryData = function (id) {
        var uri = this.APIEndPoint + "/data/history/" + id;
        var httpHeaders = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
    ...
    DeviceService.prototype.getByDevice = function (device) {
        var uri = this.APIEndPoint + "/data?device=" + device;
        var httpHeaders = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
            'Content-Type': 'application/json',
            'Authorization': "" + this.userApi.getToken()
        });
    ...
    DeviceService.prototype.getByNodo = function (nodo) {
        var uri = this.APIEndPoint + "/data?node=" + nodo;
        var httpHeaders = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
            'Content-Type': 'application/json',
            'Authorization': "" + this.userApi.getToken()
        });
    ...
    DeviceService.prototype.getByPlace = function (place) {
        var uri = this.APIEndPoint + "/" + place;
        var httpHeaders = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
            'Content-Type': 'application/json',
            'Authorization': "" + this.userApi.getToken()
        });
    ...
    DeviceService.prototype.getDataAdvancedSearch = function (id, temp, lowTemp, greatTemp, device, node) {
        var uri = this.APIEndPoint + "/data?Key=" + id + "&temperature=" + temp + "&lowerTemperature=" + lowTemp + "&greaterTemperature=" + greatTemp + "&device=" + device + "&node=" + node;
        var httpHeaders = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
            'Content-Type': 'application/json',
            'Authorization': "" + this.userApi.getToken()
        });
    ...
    DeviceService.prototype.compareData = function (dato, localData) {
        for (var i = 0; i < localData.length; i++) {
            if (JSON.stringify(dato) === JSON.stringify(localData[i]))
                return false;
        }
        return true;
    };
