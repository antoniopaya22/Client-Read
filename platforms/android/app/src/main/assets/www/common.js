...
var DeviceService = /** @class */ (function () {
    ...
    DeviceService.prototype.getHistoryData = function (id) {
        var uri = this.APIEndPoint + "/data/device/" + id;
        var httpHeaders = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
            'Content-Type': 'text/plain',
            'Authorization': "" + this.userApi.getToken()
        });
    ...
    DeviceService.prototype.getDataAdvancedSearch = function (id, temp, lowTemp, greatString, time, lowTime, greatTime, device, node) {
        var uri = this.APIEndPoint + "/data?Key=" + id + "&temperature=" + temp + "&lowerTemperature=" + lowTemp + "&greaterTemperature=" + greatString + "&hour=" + time + "&lowerHour=" + lowTime + "&greaterHour=" + greatTime + "&device=" + device + "&node=" + node;
        var httpHeaders = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
            'Content-Type': 'application/json',
            'Authorization': "" + this.userApi.getToken()
        });
